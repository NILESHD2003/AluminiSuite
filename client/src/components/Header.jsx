...
const Header = ({ children }) => {
    ...
    return (
        <>
                ...
                <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
                    <div className="flex h-16 items-center justify-between">
                        <div className="md:flex md:items-center md:gap-12">
                            <a className="block text-[#fca311]" href="#">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div className="block md:hidden">
                                <button
                                    className="rounded-md p-2 text-gray-600 hover:text-gray-700"
            ...
            <div className={`fixed inset-0 z-50 bg-gray-800 transition-opacity duration-300 ${isSidebarOpen ? 'opacity-50' : 'opacity-0 pointer-events-none'}`} onClick={closeSidebar}></div>

            <div
                className={`fixed left-0 top-0 z-50 h-full w-64 bg-white transition-transform duration-300 ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'
                    }`}
            >
                <div className="flex justify-between items-center p-4 border-b">
                    <h2 className="text-xl font-semibold">Sidebar</h2>
                    <button className="text-gray-600" onClick={closeSidebar}>

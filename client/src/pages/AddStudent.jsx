...
const ConfettiComponent = ({ show }) => {
    ...
    return (
        show && (
            <Confetti
                ref={confettiRef}
                className="absolute left-0  bottom-0 z-[9999] w-full"
            />
        )
    );
};
                        ...
                        <div className="rounded-lg bg-white p-8 shadow-lg lg:col-span-3 lg:p-12">
                            <form onSubmit={handleFormSubmit} className="space-y-4">
                                ...
                                <div className="mt-4">
                                    <button
                                        type='submit'
                                        className="inline-block w-full rounded-lg bg-yellow-600 px-5 py-3 cursor-pointer font-medium text-white sm:w-auto"
                                    >
                                        Send Enquiry
                                    </button>
                                </div>
